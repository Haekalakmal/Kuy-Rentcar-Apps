...
public class CarsUserAdapter extends RecyclerView.Adapter<CarsUserAdapter.MyViewHolder>{
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private View view;
            ...
            ic_TYPE=(ImageView)view.findViewById(R.id.ic_TYPE);
        ...
        public void bindItem(DataCars cars) {
           ...
           // bensin.setText(cars.getBENSINMOBIL().toString());
            if (Integer.parseInt(cars.getTYPEMOBIL().toString())==1){
                TYPE.setText("Automatic");
            }else {
                TYPE.setText("Manual");
            }
            ...
            ic_TYPE.setImageDrawable(DrawableColor.setColor(fuelIcon,R.color.nliveo_orange_colorPrimaryDark));
        }
    }
