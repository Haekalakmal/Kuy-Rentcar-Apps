...
public class client {
    private  static  final  String BASE_URL="http://192.168.100.10/rental-api/";
    private  static  final  String BASE_URL_IMAGE="http://192.168.100.10/rental-api/upload/avatars/";
    private  static  final  String BASE_URL_IMG="http://192.168.100.10/rental-api/upload/";
