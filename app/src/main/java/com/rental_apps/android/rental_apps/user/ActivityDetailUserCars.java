...
public class ActivityDetailUserCars extends AppCompatActivity implements InitComponent, View.OnClickListener{
    ...
    private ImageView ic_TYPE_mobil;
    ...
    private String jam;
    private TextView getTYPE_mobil;
    ...
    public void initUI() {
        ...
        TYPE_mobil=(TextView)findViewById(R.id.TYPE);
        ...
        ic_TYPE_mobil=(ImageView)findViewById(R.id.ic_TYPE);
...
//        jam =(TimePicker) findViewById(R.id.jam);
        ...
        ic_TYPE_mobil.setImageDrawable(DrawableColor.setColor(fuelIcon,R.color.nliveo_orange_colorPrimaryDark));
    ...
    public void initValue() {
       ...
       // bensin_mobil.setText(car.getBENSINMOBIL());
        if (Integer.parseInt(car.getTYPEMOBIL().toString())==1){
            TYPE_mobil.setText("Automatic");
        }else {
            TYPE_mobil.setText("Manual");
        }
